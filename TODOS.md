...
- [ ] **QA visuelle des états Suspense non capturable in situ** — Effort S (P2).
  ...
  **MAJ 2026-06-15** : la route de démo `/demo/dashboard-states`
  (feature/epic3-ui-states-iso) matérialise l'option « route de test dédiée » —
  les 3 états du dashboard y sont capturables in situ (Visual QA réussie via
  segmented control, sans flux Suspense). Reste ouvert pour `loading.tsx` du
  sélecteur (Suspense réel). Reclasser en « partiellement adressé » au merge.
