...
partitions de `transactions_cache`, commentaire faux retiré). #3 corrigé dans
0003 (REVOKE DELETE sur `transactions_cache`/`balance_history` — tombstone
strict). Différés ci-dessous :
